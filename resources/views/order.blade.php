			...
			<div class="form-group col-12">
				<form method="POST" action="@if(isset($collect_touroku)){{$collect_touroku}}@endif" name="charge_form" class="charge_form" onsubmit="return false;">
					...
					<div class="input-form row">
						...
						<div class="col-sm-12 col-md-5">
							<input type="number" class="form-control yuukoukigen" name="exp_month" maxlength="2" placeholder="10" value="">月/ <input class="form-control yuukoukigen" type="number" name="exp_year" maxlength="2" value="" placeholder="28">年
						</div>
					</div>
					<div class="input-form row">
						<div class="col-sm-12 col-md-2">
						...
						<div class="col-sm-12 col-md-5">
							<input type="number" class="form-control" name="security_code" maxlength="4" placeholder="1234" value="">
						</div>
					</div>
