              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p>SETOnagiオリジナル商品は、目利きの選んだ確かな全国の水産商品をご提供してまります。</p>
                    <ul>
                    ...
                    <ol>
                      ...
                      <li>商品のご購入は、メニューの「商品一覧」からご注文ください。</li>
                      <li>ご希望の商品を『カートに入れる』ボタンをクリックし、右上のカートアイコンから、『注文個数入力に進む』ボタンで、オーダ内容確認画面に進んでください。</li>
                      <li>カートに入れた商品から欲しい数量を選択してください。</li>
                      <li>配送方法・受け渡し希望日時・受け渡し希望時間・お支払方法を入力していただき、『内容確認画面に進む』ボタンをクリックしてください。</li>
                      <li>内容確認画面にて注文内容が正しいことを確認して、『この内容で注文する』ボタンをクリックしてください。<br>※ 修正を行う場合は、『戻って編集する』をクリックしてください。</li>
                      <li>ご登録メールアドレスに、ご注文内容を記載したメールをお送りしますのでご確認ください。<br>※スマートフォンからお手続きの方は、「@setonagi-orderbook.com」からのメールを受信できるように設定をお願いいたします。</li>
                    </ol>
                    <h2>３．商品のお引渡し日について</h2>
                    <ul>
                    <li>商品のお引渡しは、原則開市日のみとなります。（詳細は、市場休日カレンダーを確認してください）</li>
                    <li>土・日・祝・市場休日の前日17：00以降～土・日・祝・市場休日にいただいたご注文は、翌々営業日(月曜又は 祝日休日明け)のお引渡しとなります。</li>
                    <li>17:00以降のご注文は、お引渡し日は異なりますので、ご注意ください。</li>
                    </ul>
                    <p><span class="red">日曜祝祭日並びに水曜日<a href="{{ asset('pdf/2023_2024_calender.pdf') }}" target="_blank" rel="noopener">（市場休日カレンダーはこちら）</a>等の市場休日については、注文は受け付けておりますが、出荷並びに市場渡しは休み明けとなりますのでご注意ください。</span></p>
                    <h2 id="haisou">４．商品のお引渡しについて</h2>
                    ...
                    <h3>マリンネクスト (三原市糸崎) <span class="red">受け取り可能時間：9時～17時</span></h3>
                    ...
                    <p>配達契約をされている会社のお客様について</p>
                    <ul>
                      <li>指定された日時に、お客様の会社の指定の場所に配達いたします。</li>
                      <li>詳細はお客様の会社内でご確認ください。</li>
                    </ul>
                    <p>※お引き渡し場所は随時追加をいたします。</p>
                    <h2><strong>６．交換・返品について</strong></h2>
                    <ul style="list-style-type: square;">
                    <li>出荷後のキャンセルや商品の交換・返品は、食品を取り扱っている為<strong><span style="color: #ff0000;">当社が認めた不良品以外は原則お引き受けできません。</span></strong></li>
                    <li>やむを得ない場合ご注文のキャンセル、修正等に関しましては、<span style="color: #ff0000;"><strong>前日17：00までとさせていただきます。「受注確認メール」が届く前に必ずご連絡くださいますようお願いいたします。</strong></span>出荷後のご対応は出来ませんのでご注意ください。</li>
                    ...
                    <div id="kessai"></div>
                    <h2><strong>７．お支払方法について</strong></h2>
                    <ul style="list-style-type: square;">
                    <li>商品のお支払いは、クレジット会計のみになります。</li>
                    <li>クレジット会計につきましては、ご利用限度額、引落日等お支払の諸条件につきましては、ご利用のクレジットカードのご契約条件に準じます。</li>
                    </ul>
                    <h3>クレジットカード決済</h3>
                    <p>SETOnagiサイトでは取り扱いカードは以下のとおりです。</p>
                    ...
                    <h2><strong>８．領収書について</strong></h2>
                    <ul style="list-style-type: square;">
                    <li>領収書が必要な際は、注文時の【通信欄】に「領収書希望」「ご名義」「但し書き」をご入力ください。</li>
                    <li>ご登録メールアドレス宛にPDFにて送付させて頂きます。</li>
                    <li>紙面での領収書発行は対応しておりませんので、予めご了承下さい。</li>
                    <li>インボイス制度に対応しております。（事業者登録番号：T6240001039693）</li>
                    </ul>
                    <!-- <h2><strong>１０．賞味期限について</strong></h2>
                    <p>いずれの商品も、裏面に【賞味期限】を記載しておりますのでご確認ください。</p> -->
                    <h2><strong>９．お問い合わせ</strong></h2>
                    ...
                    EMAIL：<a href="mailto:info@setonagi-orderbook.com">info@setonagi-orderbook.com</a></p>
                    ...
                    ※スマートフォンからお手続きの方は、「@setonagi-orderbook.com」からのメールを受信できるように設定をお願いいたします。</li>
                    </ol>
                    <h2>３．ご注文の手順</h2>
                    <ol>
                    <li>登録時に発行されたＩＤ、パスワードでログインをしてください。</li>
                    ...
                    <p class="red">日祝日並びに水曜日（全国市場休日）お休みです。ご注文は休みの間も受け付けておりますが、出荷は休み明けとなりますのでご注意ください。<a title="市場休日カレンダー" href="{{ asset('pdf/2023_2024_calender.pdf') }}" target="_blank" rel="noopener">カレンダーはこちら</a></p>
                    ...
                    <p>&nbsp;<br>
                    <span class="red">日曜祝祭日並びに水曜日<a href="{{ asset('pdf/2023_2024_calender.pdf') }}" target="_blank" rel="noopener">（市場休日カレンダーはこちら）</a>等の市場休日については、注文は受け付けておりますが、出荷並びに市場渡しは休み明けとなりますのでご注意ください。</span></p>
                    ...
                    <ul style="list-style-type: square;">
                    <li>出荷後のキャンセルや商品の交換・返品は、食品を取り扱っている為<strong><span style="color: #ff0000;">当社が認めた不良品以外は原則お引き受けできません。</span></strong></li>
                    <li>やむを得ない場合ご注文のキャンセル、修正等に関しましては、<span style="color: #ff0000;"><strong>当日17：00までとさせていただきます。「受注確認メール」が届く前に必ずご連絡くださいますようお願いいたします。</strong></span>出荷後のご対応は出来ませんのでご注意ください。</li>
                    <li>お客様側の事情による受取辞退・保管期限切れによる返品などについても受け付けておりません。</li>
                    <li>SETOnagiの商品は運送会社の規定により保管期限が5日間となっております。</li>
                    <li>保管期限が過ぎますと、運送会社より商品が強制返品され、商品は廃棄処理となります。その場合はご返金も出来ませんので、予めご了承ください。</li>
                    <li>返品につきましては、商品に異常が認められる場合や、配送途中での変形や破損等が発生した場合、間違った商品が届いた場合に限り、弊社の費用負担で返品をお受け致します。<strong><span style="color: #ff0000;">（商品の箱及び中身は破棄せずそのままの状態で保管してください。現物がない場合は、交換は出来かねます。）</span></strong><strong><span style="color: #ff0000;"> 商品到着後3日以内にお申し出ください。</span></strong></li>
                    ...
                    <p>運営：株式会社クラハシ<br>
                    〒721-0942 広島県福山市引野町１丁目１−１<br> -->
                    EMAIL：<a href="mailto:info@setonagi-orderbook.com">info@setonagi-orderbook.com</a><br />
