...
<div class="card card-primary">
  ...
  <div class="card-body">
    ...
    @csrf
      ...
      <div id="unei_company_detail" style="display;none;">
        ...
        <div class="row">
          <div class="form-group col-6">
            ...
            <input id="szHonknjmei" type="text" class="form-control" name="szHonknjmei" placeholder="クラハシ" value="黒猫商事" autofocus>
          </div>
          <div class="form-group col-6">
            <label for="szHonknamei">運営会社名（フリガナ）</label>
            <input id="szHonknamei" type="text" class="form-control" name="szHonknamei" placeholder="クラハシ" value="クロネコショウジ" autofocus>
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            <label for="szaddress01">郵便番号(ハイフン無し7桁)</label>
            <input type="text" name="szaddress01" maxlength="7" onKeyUp="AjaxZip3.zip2addr(this,'','szaddress02','szaddress03');" class="form-control" id="szaddress01" placeholder="1001000" value="7200824">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            <label for="szaddress02">都道府県</label>
            <input type="text" name="szaddress02" id="szaddress02" class="form-control" placeholder="広島県" value="広島県">
          </div>
          <div class="form-group col-6">
            <label for="szaddress03">市区町村</label>
            <input type="text" name="szaddress03" id="szaddress03" class="form-control" placeholder="福山市〇〇町" value="福山市多治米町">
          </div>
          <div class="form-group col-6">
            <label for="szaddress04">番地</label>
            <input type="text" name="szaddress04" id="szaddress04" class="form-control" placeholder="３ー２ー２" value="３ー２ー２">
          </div>
          <div class="form-group col-6">
            <label for="szaddress05">ビル・マンション名</label>
            <input type="text" name="szaddress05" id="szaddress05" class="form-control" placeholder="◯◯ビル４階" value="プレセランス・オリビエ２０２">
          </div>
        </div>
        <div class="form-divider">
          ご連絡先
        ...
        <div class="row">
          <div class="form-group col-6">
            ...
            <input id="szTelno" type="tel" class="form-control" name="szTelno" value="080-2888-5281">
            <div class="invalid-feedback">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            ...
            <input id="szDaikjmei_sei" type="text" class="form-control" name="szDaikjmei_sei" placeholder="山田" autofocus value="山田">
          </div>
          <div class="form-group col-6">
            <label for="szDaikjmei_mei">代表者名（名）</label>
            <input id="szDaikjmei_mei" type="text" class="form-control" name="szDaikjmei_mei" placeholder="太郎" value="太郎">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            <label for="szDaiknamei_sei">フリガナ（姓）</label>
            <input id="szDaiknamei_sei" type="text" class="form-control" name="szDaiknamei_sei" placeholder="ヤマダ" value="ヤマダ">
          </div>
          <div class="form-group col-6">
            <label for="szDaiknamei_mei">フリガナ（名）</label>
            <input id="szDaiknamei_mei" type="text" class="form-control" name="szDaiknamei_mei" placeholder="タロウ" value="タロウ">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="form-group col-12">
          <input class="radio-input" type="radio" id="上記入力の取引先情報と同様" value="1" name="sqssfKbn" checked><label for="上記入力の取引先情報と同様" checked selected> 上記入力の取引先情報と同様</label>
          <input class="radio-input" type="radio" id="上記入力の運営会社情報と同様" value="2" name="sqssfKbn"><label for="上記入力の運営会社情報と同様"> 上記入力の運営会社情報と同様</label>
      ...
      <div id="soufu_detail" style="display;none;">
        <div class="row">
          <div class="form-group col-6">
            ...
            <input type="text" name="sqaddress01" maxlength="7" onKeyUp="AjaxZip3.zip2addr(this,'','sqaddress02','sqaddress03');" class="form-control" id="sqaddress01" placeholder="1001000" value="7200824">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            <label for="sqaddress02">都道府県</label>
            <input type="text" name="sqaddress02" id="sqaddress02" class="form-control" placeholder="広島県" value="広島県">
          </div>
          <div class="form-group col-6">
            <label for="sqaddress03">市区町村</label>
            <input type="text" name="sqaddress03" id="sqaddress03" class="form-control" placeholder="福山市〇〇町" value="福山市多治米町">
          </div>
          <div class="form-group col-6">
            <label for="sqaddress04">番地</label>
            <input type="text" name="sqaddress04" id="sqaddress04" class="form-control" placeholder="３ー２ー２" value="３ー２ー２">
          </div>
          <div class="form-group col-6">
            <label for="sqaddress05">ビル・マンション名</label>
            <input type="text" name="sqaddress05" id="sqaddress05" class="form-control" placeholder="◯◯ビル４階" value="プレセランス・オリビエ２０２">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-6">
            <label for="sofuKnjnam">送付先名称</label>
            <input id="sofuKnjnam" type="text" class="form-control" name="sofuKnjnam" placeholder="山田" autofocus value="山田">
          </div>
        </div>
        <!-- <div class="row">
          <div class="form-group col-6">
